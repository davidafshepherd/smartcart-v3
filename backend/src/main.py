...
from src.constants import NUTRITION_CSV_PATH, SAM3_CHECKPOINT_PATH, UPLOAD_DIR
from src.db import Base, engine, SessionLocal
from src.models.db_models import Food, MealSnapshot
from src.models.sam3 import load_sam3_model
