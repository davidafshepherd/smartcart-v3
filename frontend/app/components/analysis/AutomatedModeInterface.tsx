/**
 * @fileoverview Automated mode interface component for SAM3 segmentation.
 *
 * Provides a simple workflow for automated segmentation:
 * 1. Set confidence threshold
 * 2. Run SAM3 to automatically segment all foods
 * 3. View generated masks on images
 * 4. Re-run SAM3 if needed
 */
